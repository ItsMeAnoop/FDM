...
public class SampleAdapter extends RecyclerView.Adapter<SampleAdapter.Holder>{
    ...
    public SampleAdapter(Activity activity,ArrayList<String> data){
        this.data=data;
    ...
    public Holder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.sublist_sample_introduction, viewGroup, false);
